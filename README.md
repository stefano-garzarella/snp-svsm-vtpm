...
# Clean up everything generated by this demo (including VM image, SVSM state,
# etc.) previously, and rebuild QEMU, EDK2, IGVM, and SVSM.
./prepare.sh -c
```
...
# LUKS passphrase is now required, since the key is not yet sealed with the TPM:
# Please enter passphrase for disk QEMU_HARDDISK (luks-bf91e8fe-c1e3-4696-937f-51c83d312eb9)::
# MY-LUKS-PASSPHRASE or <custom LUKS passphrase>
